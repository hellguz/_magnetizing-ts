...
export type SpringTemplateType =
  | "small-apartment"
  | "office-suite"
  | "house"
  | "large-house"
...
export interface SpringTemplate {
  boundary: Vec2[];
  rooms: RoomState[];
...
export const m2 = (area: number) => area * 900;

export const springTemplates: Record<SpringTemplateType, SpringTemplate> = {
